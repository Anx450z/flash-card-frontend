      ...
      <div
        ...
        <div>
          ...
          <div className="my-[3rem] py-3">
            ...
            <p>Effective date: 2022-08-23</p>
            <p>
              1. <b>Introduction</b>
            </p>
            <p>
              Welcome to <b> Personal Project</b>.
            </p>
            <p>
              <b>Personal Project</b> (“us”, “we”, or “our”) operates{' '}
              <b>https://snazzy-starlight-dbf8b2.netlify.app/</b> (hereinafter referred to as{' '}
              <b>“Service”</b>).
            </p>
            <p>
              Our Privacy Policy governs your visit to{' '}
              <b>https://snazzy-starlight-dbf8b2.netlify.app/</b>, and explains how we collect,
            ...
            <p>
              Our Terms and Conditions (<b>“Terms”</b>) govern all use of our Service and together
            ...
            <p>
              <b>SERVICE</b> means the https://snazzy-starlight-dbf8b2.netlify.app/ website operated
              by Personal Project.
            </p>
            <p>
              <b>PERSONAL DATA</b> means data about a living individual who can be identified from
              those data (or from those and other information either in our possession or likely to
              come into our possession).
            </p>
            <p>
              <b>USAGE DATA</b> is data collected automatically either generated by the use of
            ...
            <p>
              <b>DATA CONTROLLER</b> means a natural or legal person who (either alone or jointly or
              in common with other persons) determines the purposes for which and the manner in
            ...
            <p>
              ...
              <b>“Personal Data”</b>). Personally identifiable information may include, but is not
              limited to:
            </p>
            ...
            <p>
              ...
              or when you access Service by or through any device (<b>“Usage Data”</b>).
            </p>
            <p>
            ...
            <p>
              0.2. <b>Preference Cookies:</b> We use Preference Cookies to remember your preferences
            ...
            <p>
              0.4. <b>Advertising Cookies:</b> Advertising Cookies are used to serve you with
            ...
            <p>
              ...
              members, social security (or other taxpayer identification) number, office location
              and other data.
            </p>
            <p>
              5. <b>Use of Data</b>
            </p>
            <p>Personal Project uses the collected data for various purposes:</p>
            ...
            <p>
              If you are located outside USA and India and choose to provide information to us,
              please note that we transfer the data, including Personal Data, to USA and India and
              process it there.
            </p>
            <p>
            ...
            <p>
              0.2.2. to contractors, service providers, and other third parties we use to support
              our business;
            </p>
            ...
            <p>
              ...
              be removed from our systems, please email us at <b>anx450z@gmail.com</b>.
            </p>
            ...
            <p>
              12.{' '}
              <b>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</b>
            </p>
            <p>
            ...
            <p>
              ...
              request(s) by email: <b>anx450z@gmail.com</b>.
            </p>
            <p>
            ...
            <p>
              ...
              visited our Service. We and our third-party vendors use cookies to inform, optimise
            ...
            <p>
              ...
              <a href="https://policymaker.io/privacy-policy/">privacy policy</a> has been made
              using <a href="https://policymaker.io/">PolicyMaker.io</a>, a free tool that helps
              create high-quality legal documents. PolicyMaker’s{' '}
              <a href="https://policymaker.io/privacy-policy/">privacy policy generator</a> is an
              easy-to-use tool for creating a{' '}
              <a href="https://policymaker.io/blog-privacy-policy/">privacy policy for blog</a>,
            ...
            <p>
              This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was created
              for <b>https://snazzy-starlight-dbf8b2.netlify.app/</b> by{' '}
              <a href="https://policymaker.io">PolicyMaker.io</a> on 2022-08-23.
            </p>
          </div>
        </div>
      </div>
